...
function SideElement({title, icon, icon_dark, titleClassName, sideClassName, notification, notificationClassName} : SideElementT) {
    const {theme} = useTheme()
  return (
    // <div className="w-full flex justify-between items-center ">
        <div className={cn('flex w-full justify-between items-center gap-2 py-3.5 px-2 pl-4 max-md:text-[13px] hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black capitalize text-[13.5px] cursor-pointer rounded-md group ease-in-out transition-all duration-500', sideClassName)}>
